...
void
print_file_type(std::ostream &stream, fsys::path const &path, fsys::file_status status)
{
...
uintmax_t
get_file_size(fsys::path const &path)
{
    std::error_code ec;
...
fsys::file_time_type
get_last_write_time(fsys::path const &path)
{
    std::error_code ec;
