...
public:
    ...
    constexpr rational(value_type num = 0)
        : numerator_ { num }
        , denominator_ { 1 }
    {
    }
    ...
    template <class U> rational(rational<U> const &that);
    ...
    template <class U> constexpr U as() const { return static_cast<U>(numerator()) / denominator(); }
    ...
    template <class U> rational &operator=(rational<U> const &rhs);
...
private:
    ...
    template <class U> value_type scale(U value);
...
rational<T>::rational(double r)
    : numerator_ { static_cast<T>(r / 100000) }
    , denominator_ { static_cast<T>(100000) }
{
}
...
rational<T>::rational(rational<U> const &that)
    : numerator_ { scale<U>(that.numerator()) }
    , denominator_ { scale<U>(that.denominator()) }
{
    reduce();
}
...
template <class T>
rational<T> &
rational<T>::operator+=(rational const &rhs)
{
...
template <class T>
rational<T> &
rational<T>::operator+=(value_type const &rhs)
{
...
template <class T>
rational<T>
operator+(rational<T> lhs, rational<T> const &rhs)
{
    lhs += rhs;
    return lhs;
}
...
template <class T>
rational<T>
operator+(rational<T> lhs, T const &rhs)
{
    lhs += rhs;
    return lhs;
}
...
template <class T>
rational<T>
operator+(T const &lhs, rational<T> rhs)
{
    rhs += lhs;
    return rhs;
}
...
template <class T>
constexpr bool
operator==(rational<T> const &a, rational<T> const &b)
{
...
template <class T>
constexpr bool
operator==(rational<T> const &lhs, T rhs)
{
    return lhs.denominator() == 1 and lhs.numerator() == rhs;
}

/// Equality comparison
template <class T>
constexpr bool
operator==(T lhs, rational<T> const &rhs)
{
    return rhs.denominator() == 1 and rhs.numerator() == lhs;
}
...
template <class T>
constexpr bool
operator<(rational<T> const &a, T const &b)
{
...
template <class T>
constexpr bool
operator<(T const &a, rational<T> const &b)
{
...
template <class T>
constexpr bool
operator!=(rational<T> const &a, T b)
{
    return not(a == b);
}
...
template <class T>
constexpr bool
operator!=(T a, rational<T> const &b)
{
    return not(a == b);
}
