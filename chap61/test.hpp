...
inline void
print_stderr(Head &&head, Rest &&...rest)
{
...
template <class... Args>
inline void
test_failed(char const *file, int line, Args &&...args)
{
...
template <class T>
inline void
test(char const *file, unsigned long long line, T const &_condition_)
{
...
inline void
test_equal(char const *file, unsigned long long line, E const &expected, A const &actual)
{
