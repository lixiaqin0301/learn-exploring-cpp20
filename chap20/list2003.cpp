...
/** Initialize the I/O streams by imbuing them with the given locale.
 ...
 */
void
initialize_streams(std::locale locale)
{
 ...
 */
void
print_pair(count_pair pair, str_size longest)
{
 ...
 */
std::string
sanitize(std::string str, std::locale loc)
{
    std::string result {};
    for (char ch : str) {
