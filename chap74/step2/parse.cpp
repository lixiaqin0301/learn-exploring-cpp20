...
bool
parser::get_number(std::string const &token, double &result)
{
...
bool
parser::get_add_expr(double &result)
{
...
bool
parser::get_mul_expr(double &result)
{
...
bool
parser::get_unary(double &result)
{
    std::string token {};
...
bool
parser::get_primary(double &result)
{
    std::string token {};
    if (kind k = get_token(token)) {
        if (k == '(') {
