...
{
    // Here's a new trick that I don't cover in the book: raw strings.
    //     R"stuff(raw characters)stuff"
    // Start with the R prefix. The "stuff" can be any characters
 ...
 */
bool
parser::get_number(double &result)
{
    std::string token {};
    char c {};
    if (not input_.get(c)) {
