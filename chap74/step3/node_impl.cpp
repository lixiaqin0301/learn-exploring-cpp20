...
std::string const &
node_identifier::identifier() const
{
    return identifier_;
}
...
node
node_assign::identifier() const
{
    return identifier_;
}

node
node_assign::value() const
{
    return value_;
}

std::string
node_assign::get_identifier() const
{
    return identifier().to_string();
}

double
node_assign::evaluate_value() const
{
    return value().evaluate();
}

void
node_assign::print_node(std::ostream &stream, int indent) const
{
...
double
node_assign::evaluate_node() const
{
