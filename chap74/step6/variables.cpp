...
std::vector<symbol_table> symbol_tables { { { "pi", 3.14159265358979323846 }, { "e", 2.71828182845904523536 } } };
}

local_symbol_table::local_symbol_table() { symbol_tables.emplace_back(); }

local_symbol_table::~local_symbol_table() { symbol_tables.pop_back(); }

bool
find_symbol(std::string_view name, node &value)
{
...
void
set_variable(std::string name, node value)
{
...
void
set_function(std::string name, node value)
{
