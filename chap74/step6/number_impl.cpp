...
void
number_impl::save(std::ostream &stream) const
{
    do_save(stream);
}
...
void
number_impl::print(std::ostream &stream) const
{
    stream << to_string();
}

std::string
number_impl::to_string() const
{
    return do_to_string();
}
...
bool
number_impl::equals(number_impl const &rhs) const
{
    return do_equals(rhs);
}

bool
number_impl::less(number_impl const &rhs) const
{
    return do_less(rhs);
}
...
std::shared_ptr<number_impl>
number_impl::promote_to_void()
{
    return shared_from_this();
}

std::shared_ptr<number_impl>
number_impl::promote_to_long()
{
    return shared_from_this();
}

std::shared_ptr<number_impl>
number_impl::promote_to_rational()
{
    return shared_from_this();
}

std::shared_ptr<number_impl>
number_impl::promote_to_double()
{
    return shared_from_this();
}

std::string
number_void::do_to_string() const
{
    return std::string {};
}

void
number_void::do_save(std::ostream &stream) const
{
    stream << "void ";
}
...
bool
number_void::do_equals(number_impl const &) const
{
    return false;
}
...
bool
number_void::do_less(number_impl const &) const
{
    return false;
}
...
std::shared_ptr<number_impl>
number_void::do_add(number_impl const &)
{
    return shared_from_this();
}

std::shared_ptr<number_impl>
number_void::do_subtract(number_impl const &)
{
    return shared_from_this();
}

std::shared_ptr<number_impl>
number_void::do_multiply(number_impl const &)
{
    return shared_from_this();
}

std::shared_ptr<number_impl>
number_void::do_divide(number_impl const &)
{
    return shared_from_this();
}

std::shared_ptr<number_impl>
number_void::do_promote(number_impl &rhs) const
{
    return rhs.promote_to_void();
}

std::string
number_long::do_to_string() const
{
...
void
number_long::do_save(std::ostream &stream) const
{
    stream << "long " << value() << ' ';
}

bool
number_long::do_equals(number_impl const &rhs) const
{
    return value() == dynamic_cast<number_long const &>(rhs).value();
}

bool
number_long::do_less(number_impl const &rhs) const
{
    return value() < dynamic_cast<number_long const &>(rhs).value();
}

std::shared_ptr<number_impl>
number_long::do_add(number_impl const &rhs)
{
    return std::make_shared<number_long>(value_ + dynamic_cast<number_long const &>(rhs).value());
}

std::shared_ptr<number_impl>
number_long::do_subtract(number_impl const &rhs)
{
    return std::make_shared<number_long>(value_ - dynamic_cast<number_long const &>(rhs).value());
}

std::shared_ptr<number_impl>
number_long::do_multiply(number_impl const &rhs)
{
    return std::make_shared<number_long>(value_ * dynamic_cast<number_long const &>(rhs).value());
}
...
std::shared_ptr<number_impl>
number_long::do_promote(number_impl &rhs) const
{
    return rhs.promote_to_long();
}

std::shared_ptr<number_impl>
number_long::promote_to_void()
{
    return std::make_shared<number_void>();
}

std::shared_ptr<number_impl>
number_long::promote_to_rational()
{
    return std::make_shared<number_rational>(value());
}

std::shared_ptr<number_impl>
number_long::promote_to_double()
{
    return std::make_shared<number_double>(value());
}

std::string
number_rational::do_to_string() const
{
    std::ostringstream stream {};
    stream << value();
    return stream.str();
...
void
number_rational::do_save(std::ostream &stream) const
{
    stream << "rational " << value() << ' ';
}

bool
number_rational::do_equals(number_impl const &rhs) const
{
    return value() == dynamic_cast<number_rational const &>(rhs).value();
}

bool
number_rational::do_less(number_impl const &rhs) const
{
    return value() < dynamic_cast<number_rational const &>(rhs).value();
}
...
std::shared_ptr<number_impl>
number_rational::do_promote(number_impl &rhs) const
{
    return rhs.promote_to_rational();
}

std::shared_ptr<number_impl>
number_rational::promote_to_void()
{
    return std::make_shared<number_void>();
}

std::shared_ptr<number_impl>
number_rational::promote_to_double()
{
    return std::make_shared<number_double>(static_cast<double>(value()));
}

std::string
number_double::do_to_string() const
{
    std::ostringstream stream {};
    stream << value();
    return stream.str();
...
void
number_double::do_save(std::ostream &stream) const
{
    stream << "double " << value() << ' ';
}

bool
number_double::do_equals(number_impl const &rhs) const
{
    return value() == dynamic_cast<number_double const &>(rhs).value();
}

bool
number_double::do_less(number_impl const &rhs) const
{
    return value() < dynamic_cast<number_double const &>(rhs).value();
}

std::shared_ptr<number_impl>
number_double::do_add(number_impl const &rhs)
{
    return std::make_shared<number_double>(value_ + dynamic_cast<number_double const &>(rhs).value());
}

std::shared_ptr<number_impl>
number_double::do_subtract(number_impl const &rhs)
{
    return std::make_shared<number_double>(value_ - dynamic_cast<number_double const &>(rhs).value());
}

std::shared_ptr<number_impl>
number_double::do_multiply(number_impl const &rhs)
{
    return std::make_shared<number_double>(value_ * dynamic_cast<number_double const &>(rhs).value());
}
...
std::shared_ptr<number_impl>
number_double::do_promote(number_impl &rhs) const
{
    return rhs.promote_to_double();
}

std::shared_ptr<number_impl>
number_double::promote_to_void()
{
    return std::make_shared<number_void>();
}
